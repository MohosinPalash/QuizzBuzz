...
public class QuestionActivity extends AppCompatActivity {
    ...
    String answers[] = {"Queue","Queue","Program","Quick Sort","public","import pkg.*","None of the mentioned","java","equals()","int"};
    String opt[] = {
            "Queue","Linked List","Stack","Union",
            "Stack","Queue","Linked List","Array",
            "Flowchart","Program","Pseudocode","Syntax",
